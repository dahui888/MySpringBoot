...
//    private static String projectPath = "mall-springboot-swagger2";

    //基本包名
    private static String basePackage = "com.zlp";
    //作者
    private static String authorName = "LiPing.Zou";
    //要生成的表名 JS_ENFOR","JS_DOC
    private static String[] tables = {"sys_leo"};
    ...
    private static String url = "jdbc:mysql://127.0.0.1:3306/fish_leo?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8";
...
//            canonicalPath = System.getProperty("user.dir") + "/"+projectPath;
        ...
        gen.setGlobalConfig(new GlobalConfig()
                ...
                .setDateType(DateType.ONLY_DATE)//mysql timestamp由java.util.Date类型映射               .
