...
public class RedisUtils {
    ...
    public String getLock(String key) {
        String uuid = TokenUUIDUtil.getUUID();
    ...
    public List<Object> getBatch(List<Object> keys, long expireTime) {
        //使用pipeline方式
        List<Object> objects = redisTemplate.executePipelined(new RedisCallback<List<Object>>() {
            @Override
...
//                    connection.get(redisTemplate.getKeySerializer().serialize(e));
    ...
    public void unLock(String key,String lockId) {
        // 如果该锁的id 等于lockId 是同一把锁情况才可以删除
        if (get(key).equals(lockId)) {
            delete(key);
        }
    }
     ...
     * @return
     */
    public boolean setKeyBySECONDS(String key, String value, long time) {
     ...
     * @return
     */
    public boolean setKeyByMINUTES(String key, String value, long time) {
     ...
     * @return
     */
    public boolean setKeyByHOURS(String key, String value, long time) {
     ...
     * @return
     */
    public boolean setKeyByDAYS(String key, String value, long time) {
